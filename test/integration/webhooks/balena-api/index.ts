...
export default {
	...
	'unknown-resource': {
		...
		steps: [require('./unknown-resource/01.json')],
	},
	'new-user-no-email': {
		expected: require('./new-user-no-email/expected.json'),
		steps: [require('./new-user-no-email/01.json')],
	},
	...
	'new-user': {
		...
		steps: [require('./new-user/01.json')],
	},
	'new-user-no-info': {
		expected: require('./new-user-no-info/expected.json'),
		steps: [require('./new-user-no-info/01.json')],
	},
